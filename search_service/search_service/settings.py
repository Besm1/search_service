...
SECRET_KEY = 'django-insecure-62*luntg8521p2an=v2ls=dq=1egb)c_m^2sx*ea!qpezftn8m'
...
DATABASE_ROUTERS = [
    'search.db_routers.DefaultRouter',
    'search.db_routers.ProfileRouter',
]
